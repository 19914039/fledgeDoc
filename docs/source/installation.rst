...
.. code-block:: console
  ...
  sudo apt-get install avahi-daemon curl cmake g++ make build-essential autoconf automake uuid-dev libtool libboost-dev libboost-system-dev libboost-thread-dev libpq-dev libssl-dev libz-dev python2-dev python3-dev python3-pip python3-numpy postgresql sqlite3 libsqlite3-dev
